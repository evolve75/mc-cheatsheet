...
\sect{Launch \& CLI options — \mbox{mc\(1\)}}\par
\begin{itemize}
...
\sect{User menu macros — \mbox{mc\(1\)}}\par
\begin{keytable}
...
\sect{Keymaps and Learn keys — \mbox{mc\(1\)}}\par
\begin{keytable}
...
\sect{VFS:\@ browse “special paths” — \mbox{mc\(1\)}}\par{}
\begin{keytable}
...
\sect{Archives and EXTfs — \mbox{mc\(1\)}}\par{}
\begin{keytable}
...
\sect{Undelete (optional ext2) — \mbox{mc\(1\)}}\par{}
\begin{keytable}
...
\sect{Configuration paths — \mbox{mc\(1\)}}\par{}
\begin{keytable}
...
\sect{Subshell notes — \mbox{mc\(1\)}}\par{}
\begin{keytable}
...
\begin{keytable}
\ks{\mbox{mc\(1\)}} & \tinyurl{https://source.midnight-commander.org/man/mc.html}\\
