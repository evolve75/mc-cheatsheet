...
\fancyhead[LE,RO]{\textsf{Midnight Commander (mc)}}
\fancyhead[LO,RE]{\textsf{Cheatsheet}}
% Footer: page number on the outer edge (two-sided)
\fancyfoot[LE,RO]{\textsf{Page \thepage\ of 4}}
\fancyfoot[LO,RE]{\textsf{mc}}
