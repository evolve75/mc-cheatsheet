...
% Two-sided booklet: inner = near fold, outer = thumb edge

% Header: title on inner edge, "Cheatsheet" on outer edge
\fancyhead[LE,RO]{\textsf{\color{MCGray}Midnight Commander}}
\fancyhead[LO,RE]{\textsf{\color{MCGray}Cheatsheet}}

% Footer: "mc" on inner edge, page number on outer edge
\fancyfoot[LO,RE]{\textsf{\color{MCGray}mc}}
...
\newcommand{\ks}[1]{\textbf{\color{MCKey}\texttt{#1}}}
\newcommand{\sect}[1]{\Needspace{7\baselineskip}\textsf{\color{MCBlue}\bfseries #1}}
